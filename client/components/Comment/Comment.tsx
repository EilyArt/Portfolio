    ...
    await axios({
      ...
      .then((res: any) => {
        if (like)
          ...
          return notify(
            `You Disliked ${comment.username}'s comment.`,
            "danger",
          );
      })
      .catch((err: any) => {
    ...
    <div>
          ...
          <div className="comment-info-actions">
            <div>
              <div className="comment-info-actions-emotion">
                <div
                  className={`${comment.likes.includes(ip) && "color-accent"}`}
                >
                  <button onClick={() => reaction(true, id)}>
                    <FaThumbsUp />
                  </button>
                ...
                <div
                  className={`${
                    comment.dislikes.includes(ip) && "color-accent"
                  }`}
                >
                  <button onClick={() => reaction(false, id)}>
                    <FaThumbsDown />
                  </button>
              ...
              <div className="comment-info-actions-emotion-proportion">
                <div
                  className="comment-info-actions-emotion-proportion-bar"
                  style={{
                    width: `${Math.trunc(
                      (comment.likes / (comment.likes + comment.dislikes)) *
                        100,
                    )}%`,
                  }}
                ></div>
            ...
            <button
              className="comment-info-actions-comment"
              onClick={() =>
                document
      ...
      <div className="replies">
                ...
                <div className="comment-info-actions">
                  <div>
                    <div className="comment-info-actions-emotion">
                      <div
                        className={`${
                          reply.likes.includes(ip) && "color-accent"
                        }`}
                      >
                        <button onClick={() => reaction(true, reply.id)}>
                          <FaThumbsUp />
                        </button>
                      ...
                      <div
                        className={`${
                          reply.dislikes.includes(ip) && "color-accent"
                        }`}
                      >
                        <button onClick={() => reaction(false, reply.id)}>
                          <FaThumbsDown />
                        </button>
                    ...
                    <div className="comment-info-actions-emotion-proportion">
                      <div
                        ...
                        style={{
                          width: `${Math.trunc(
                            (reply.likes / (reply.likes + reply.dislikes)) *
                              100,
                          )}%`,
                        }}
                      ></div>
        ...
        <div className="replies-actions">
          {repliesLength >= 1 && viewIndex < repliesLength && (
            <small onClick={() => viewMoreReplies()}>
              view more replies
              <FaCaretDown />
            </small>
          )}
          {viewIndex > 0 && (
            <small onClick={() => collapseReplies()}>
              collapse replies
              <FaCaretUp />
            </small>
          )}
