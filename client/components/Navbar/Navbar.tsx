    ...
    <div className="navbar pad-default-horizontal">
      ...
      <div className="navbar-links">
        <Link href="/">
          <a
            className={`${
              router.pathname.toString() === "/" && "linkActive"
            }  pad-2`}
          >
            Home
          </a>
        ...
        <Link href="/blog">
          <a
            className={`${
              router.pathname.includes("blog") && "linkActive"
            }  pad-2`}
          >
            Blog
          </a>
        ...
        <Link href="/portfolio">
          <a
            className={`${
              router.pathname.includes("portfolio") && "linkActive"
            }  pad-2`}
          >
            Portfolio
          </a>
        ...
        <Link href="/contact">
          <a
            className={`${
              router.pathname.includes("contact") && "linkActive"
            }  pad-2`}
          >
            Contact
          </a>
