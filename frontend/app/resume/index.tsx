...
import { queryResume as query } from "../middleware/queries";
    ...
    <About cv={cv}>
      ...
      <div className="m-top-2 pad-vertical-2">
        <AboutSection
          src={pin}
          title="EDUCATION"
          records={educations?.map((education: any) => {
            return {
      ...
      <div className="m-top-2 pad-vertical-2">
        <AboutSection
          src={pin}
          title="EXPERIENCE"
          records={experiences?.map((experience: any) => {
            return {
      ...
      <div className="m-top-2 pad-vertical-2">
        <AboutSection
          src={pin}
          title="LANGUAGES"
          records={languages.map((language: any) => {
            return {
      ...
      <div className="m-top-2 pad-vertical-2">
        <AboutSection
          src={pin}
          title="CERTIFICATES"
          records={certificates.map((certificate: any) => {
            return {
