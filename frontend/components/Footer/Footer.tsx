...
import LatestNewsBox from "../LatestNewsBox/LatestNewsBox";
import BestSellerProject from "../BestSellerProject/BestSellerProject";
import MediaIcon from "../MediaIcon/MediaIcon";
import { useQuery } from "@apollo/client";
import { queryFooter as query } from "../../app/middleware/queries";
  ...
  return (
    <footer className="pad-default pad-bottom-0">
      ...
      <div className="container">
        <div className="col m-right-2">
          ...
          <div className="pad-vertical-2">
            <address>
              <FaMapMarkerAlt className="m-right-2" />
              {cv && cv.address && cv.address}
            </address>
          </div>
          <div className="pad-vertical-2">
            <a>
              <FaWhatsapp className="m-right-2" />
              {cv && cv.phone && cv.phone}
            </a>
          </div>
          <div className="pad-vertical-2">
            <a>
              <FaPaperPlane className="m-right-2" />
              {cv && cv.email && cv.email}
            </a>
          </div>
        </div>
        <div className="col m-right-2">
        ...
        <div className="col m-right-2">
          ...
          <a
            href="https://twitter.com/EILYAAMIN?ref_src=twsrc%5Etfw"
          ...
          >
            <FaTwitter /> Follow @EILYAAMIN
          </a>
          <div className="pad-vertical-2">
            <h4 className="pad-vertical-2">My Newsletter</h4>
            <aside className="pad-vertical-2">
              Please join my newsletter to get notifications for new posts and
              projects.
              <br /> It can make my day ;)
            </aside>
            <div className="pad-vertical-2">
              <InputEmail />
            </div>
      ...
      <div className="container rights">
        <small className="width-fit">
          Copyright © 2022 All rights reserved.
        </small>
        <small className="copyright width-fit">
          This website is made by &nbsp;<b>EILYA</b>
          <FaHeart />
        </small>
      </div>
    </footer>
